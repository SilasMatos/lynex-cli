...
export const TreeProvider = ({
  ...
  const isExpandControlled =
    controlledExpandedIds !== undefined && onExpandChange !== undefined
  const expandedIds = isExpandControlled
  ...
  const toggleExpanded = useCallback(
    (nodeId: string) => {
      if (isExpandControlled && controlledExpandedIds && onExpandChange) {
    ...
    [isExpandControlled, controlledExpandedIds, onExpandChange]
  )
